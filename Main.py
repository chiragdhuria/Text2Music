...
file_path = 'audio_output/audio_0.wav'
...
st.set_page_config(
    ...
    page_title= "Text2Music Synthesizer"
)

def main():

    st.title("Text2Music Synthesizer🎵")

    with st.expander("See explanation"):
        st.write("Music Generator app built using Meta's Audiocraft library.")
